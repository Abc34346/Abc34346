...
cmd({ 
  ...
  reply("*_DATABASE UPDATE TECH-TECHRESTARTING NOW...🚀_*"); 
  await sleep(1500); 
  exec("pm2 restart all"); 
  reply("*_TECH-TECHSTARTED NOW...🚀_*"); 
});
...
reply("*_TECH TECHSTARTED NOW...🚀_*");
        ...
        return reply("❌ InvTECHd mode. Please use `.mode private` or `.mode public`.");
    }
});
